/**
 * Logger centralizado para el main process.
 * Escribe a stdout con formato consistente.
 * En el futuro se puede extender para escribir a archivo.
 */
...
export function createLogger(module: string) {
  return {
    debug: (msg: string, ...args: any[]) => {
      if (shouldLog('debug')) console.log(format('debug', module, msg), ...args);
    },
